...
let BullModule = BullModule_1 = class BullModule {
    ...
    static createAsyncOptionsProvider(options) {
        if (options.useFactory) {
            return {
                provide: get_queue_options_token_util_1.getQueueOptionsToken(options.name),
        ...
        return {
            provide: get_queue_options_token_util_1.getQueueOptionsToken(options.name),
            useFactory: (optionsFactory) => __awaiter(this, void 0, void 0, function* () { return optionsFactory.createBullOptions(); }),
            inject,
        };
    }
    static forRoot() {
