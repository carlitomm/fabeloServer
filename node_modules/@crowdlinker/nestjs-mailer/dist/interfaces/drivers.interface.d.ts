...
export declare type NodemailerTransportDrivers<T extends NodemailerDrivers> = INodemailerTransportDrivers[T];
export declare type NodemailerDefaultsDrivers<T extends NodemailerDrivers> = INodemailerDefaultsDrivers[T];
